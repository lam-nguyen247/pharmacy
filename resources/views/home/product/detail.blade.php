                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="section-heading">
                                        ...
                                        <p data-cms="{{ app()->getLocale() }}-product-39">Chắc chắn Khách hàng sẽ vô cùng
                                            hài lòng. Lựa chọn Tuyệt vời nhất cho Doanh Nghiệp của bạn là Lựa chọn TTB
                                            Group.</p>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <fieldset>
                                        <input type="hidden" name="content" id="content"
                                            value="Liên hệ mua sản phẩm {{ $product->name }}">
                                        <input type="name" name="name" id="name" placeholder="@lang('Full Name')"
                                            autocomplete="on" required>
                                    </fieldset>
                                </div>
                                <div class="col-lg-12">
                                    <fieldset>
                                        <input type="text" name="phone" id="phone" placeholder="@lang('Your Phone')"
                                            required="">
                                    </fieldset>
                                </div>
                                <div class="col-lg-12">
                                    <fieldset>
                                        <input type="number" name="company" id="company" placeholder="@lang('Quantity')"
                                            required="">
                                    </fieldset>
                                </div>
                                <div class="col-lg-12">
                                    <fieldset>
                                        <button type="submit" id="form-submit"
                                            class="main-gradient-button">@lang('Buy')</button>
                                    </fieldset>
                                </div>
                            </div>
                        </form>
