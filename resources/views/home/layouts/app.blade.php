...
<head>
    ...
    <body id="body-site">
                                ...
                                <li class="has-sub">
                                    <a href="javascript:void(0)" style="margin-right:5px">
                                        <img class="img-fluid" loading="lazy"
                                            @src="/images/home/flag_{{ app()->getLocale() }}.png" alt="image">
                                        <em>{{ app()->getLocale() == 'en' ? __('English') : __('Vietnamese') }}</em>
                                    </a>
                                    <ul class="sub-menu">
                                        <li>
                                            <a href="/en" title="Tiếng Anh">
                                                <img class="img-fluid" loading="lazy" src="/images/home/flag_en.png"
                                                    alt="Tiếng Anh">
                                                <span>Tiếng Anh</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/vi" title="Tiếng Việt">
                                                <img class="img-fluid" loading="lazy" src="/images/home/flag_vi.png"
                                                    alt="Tiếng Việt">
        ...
        <!-- ***** Header Area End ***** -->
        @yield('content')
        <a id="scrolltop" class="scroll-top active"
        ...
        <section class="contact-us" id="contact-section">
            <div class="container-fluid" style="padding: 0px 60px">
                <div class="row">
                    ...
                    <div class="column col-lg-3">
                        <div class="info">
                            ...
                            <p>@lang('Address'): <span data-cms="{{ app()->getLocale() }}-address">Cụm công nghiệp Minh
                                    lãng, xã Minh Lãng, huyện Vũ Thư, tỉnh Thái Bình.</span></p>
                            ...
                            <p data-cms="{{ app()->getLocale() }}-policy">Giấy chứng nhận ĐKKD số 1001232559 do Sở Kế
                                hoạch và Đầu tư Thái Bình cấp ngày 03/08/2021</p>
                        </div>
                    </div>
                ...
                background: none;
            ">
                                <input type="email" name="email" class="email" placeholder="@lang('E-Mail Address')"
                                    style="
                width: 57%;
                margin: 0px;
            ...
            ">@lang('Send')</button>
                            ...
                            <ul class="social-icons">
                                <li><a href="https://www.facebook.com/ttbgroup.vn" target="_blank"><i
